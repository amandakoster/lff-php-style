...
<div class="row">
	...
	<div class="col-sm-8 col-sm-offset-2 site-motto">

		<center>

			<p class="lead">Iconistyle. We'll help you find the right fitting clothes so you can look your best!.</p>
    ...
    <div class="filter_button" style="margin-bottom: 5px">

     <center><button class="btn btn-default btn-sm" type="button" data-toggle="collapse" data-target="#size-form" aria-expanded="false" aria-controls="size-form" id="filter_button" type="submit">Size Filter</button></center> </div>
	...
	if (is_home()) {
		...
		if ('likes' == $popularity) {
			...
			add_filter('posts_orderby', 'ipin_meta_value_num_orderby');

			query_posts($args);

			remove_filter('posts_where', 'filter_where');

			remove_filter('posts_orderby', 'ipin_meta_value_num_orderby');
			...
			add_filter('posts_orderby', 'ipin_comments_orderby');

			query_posts($args);

			remove_filter('posts_where', 'filter_where');

			remove_filter('posts_orderby', 'ipin_comments_orderby');
